...
void Recognition::Hough3DGrouping(double threshold, double bin_size,
                                  bool use_interpolation,
                                  bool use_distance_weight,
                                  float normals_radius, float rf_adius) {
  pcl::console::TicToc time;
  time.tic();
  Clusters clusters;
  pcl::Hough3DGrouping<PointXYZRGBN, PointXYZRGBN, pcl::ReferenceFrame,
                       pcl::ReferenceFrame>
      h3dg;
