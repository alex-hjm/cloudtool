...
namespace ct
{
    ...
    public slots:
         ...
         *                     以便在计算参考框架时考虑
         */
        void BOARDLocalReferenceFrameEstimation(float radius, bool find_holes,
         ...
         */
        void CVFHEstimation(float vpx, float vpy, float vpz, float radius_normals,
         ...
         */
        void FLARELocalReferenceFrameEstimation(float radius, float margin_thresh,
        ...
        /**
         * @brief 在给定 XYZ 数据的情况下，估计给定点云数据集的全局对齐空间分布 (GASD)
         * 描述符
         * @param dir 设置视图方向
         ...
         * @param cache_size 设置最大内部缓存大小
         * @param use_cache 设置是否使用内部缓存机制来删除冗余计算
         */
        void PFHEstimation(int cache_size, bool use_cache);
         ...
         * @param save 设置是否应保存完整的距离-角度直方图
         */
        void RSDEstimation(int nr_subdiv, double plane_radius, bool save);
         ...
         * @brief VFHEstimation
         * @param vpx vpy vpz 设置视点
         * @param use_n 是否使用设置的法线
         * @param normal 设置使用法线
         * @param use_c 是否使用设置的质心
         * @param centroid 设置使用质心
         * @param normalize_bin 设置归一化 bin
         * @param normalize_dst 设置归一化距离
