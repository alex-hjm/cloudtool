#ifndef PCA_RECOGNITION_H
#define PCA_RECOGNITION_H
...
class PCA_EXPORT Recognition : public QObject {
  Q_OBJECT
 public:
  explicit Recognition(QObject *parent = nullptr)
      : QObject(parent), scene_(), model_(), corrs_() {}
  ...
  /**
   * @brief
   * 提供指向输入数据集中的点与场景数据集中的点之间预先计算的对应关系的指针
   */
